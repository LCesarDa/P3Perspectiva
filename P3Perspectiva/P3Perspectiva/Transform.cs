...
namespace P3Perspectiva
{
    ...
    {
        public Boolean ex = false, ye = false, ze = false;
        private float size, a;
        private Vertex angle = new Vertex();
        private Vertex position = new Vertex();
        Matrix p, s, rz, ry, rx, fov,
            d = new Matrix(new float[,]
            {
        ...
        {
            Matrix vm = new Matrix(new float[,]
            {
                {v.X},
                {v.Y},
                {v.Z},
        ...
        public PointF TransformationU(Vertex o, Transform c)
        {
            ...
            Matrix vm1 = new Matrix(new float[,]
            {
                {v.X},
                {v.Y},
                {v.Z},
            ...
            Matrix vm2 = new Matrix(new float[,]
            {
                {vm1[0, 0]/vm1[2, 0]},
                {vm1[1, 0]/vm1[2, 0]}
            });
